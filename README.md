...
[ACCESS-Hive](https://access-hive.org.au/) contains [detailed instructions for how to configure and run ACCESS-OM2 with `payu`](https://docs.access-hive.org.au/models/run_a_model/run_access-om2/).
